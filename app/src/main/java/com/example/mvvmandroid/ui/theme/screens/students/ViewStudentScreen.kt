...
import com.example.mvvmandroid.models.Student
        ...
        Scaffold(
            bottomBar = {
                NavigationBar (
                    ...
                    com.example.mvvmandroid.ui.theme.screens.students.bottomNavItems.forEachIndexed { index, bottomNavItem ->
                        NavigationBarItem(
...
@Composable
fun StudentItem(name:String, email:String, age:String, id:String,
...
fun ViewStudentScreenPreview(){
    ...
    ViewStudentScreen(navController = rememberNavController())
