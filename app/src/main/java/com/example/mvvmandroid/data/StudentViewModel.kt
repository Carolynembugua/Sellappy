package com.example.mvvmandroid.data
...
import com.example.mvvmandroid.navigation.VIEW_PRODUCTS_URL
...
class StudentViewModel(var navController: NavController, var context: Context) {
    ...
    fun uploadStudent(name:String, email:String, age:String, phone: String,filePath: Uri){
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var student = Student(name,age,email,phone,imageUrl,studentId)
